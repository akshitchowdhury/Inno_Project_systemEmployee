...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(loggedInUSer.rejected, (state, action) => {
            state.loading = false;  // Stop loading if login fails
            state.error = action.payload;
        })

        // Handle loggedOutUser
        .addCase(loggedOutUser.pending, (state) => {
            state.loading = true;  // Start loading when logging out
        })
        .addCase(loggedOutUser.fulfilled, (state, action) => {
            state.loading = false;  
            
            state.isAuthenticated = false;// Stop loading after logout
            const loggedUser = state.users.find(
